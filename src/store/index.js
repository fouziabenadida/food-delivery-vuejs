...
export default new Vuex.Store({
  state: {
    products: [
      {
        id: 1, name: "Cake",img:"https://images.unsplash.com/photo-1542826438-bd32f43d626f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1592&q=80", price: "100.15", description: "Very Tasty Cake", rate: "4.1"
      },
      {
